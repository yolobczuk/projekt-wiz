  ...
  output$zad6 <- renderPlot({
    ...
    ggplot(df.pkt6, aes(x=pogoda, y=Licznik)) + 
      ...
      theme(axis.text.x = element_text(size = 18), 
            axis.text.y = element_text(size = 18), axis.title=element_text(size=18, face="bold"),
            plot.title = element_text(size=22, face="bold", hjust = 0.5)) +
      labs(title=paste("Zależność liczby przejazdów od zmiennej", input$choice_6_pogoda), x = input$choice_6_pogoda, y = "Liczba przejazdów")
  ...
  output$zad7 <- renderPlot({
    ...
    ggplot(df.pkt7, aes(x=pogoda, y=Licznik, color=Stacja)) + 
      ...
      theme(axis.text.x = element_text(size = 18), 
            axis.text.y = element_text(size = 18), axis.title=element_text(size=18, face="bold"),
            plot.title = element_text(size=22, face="bold", hjust = 0.5)) +
      labs(title=paste("Zależność liczby przejazdów dla",length(st7)," stacji od zmiennej", input$choice_7_pogoda), x = input$choice_6_pogoda, y = "Liczba przejazdów")
